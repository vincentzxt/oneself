<template>
	<view class="container">
		...
		<xw-date title="费用日期" orderList="orderList" :start_date="search_startDate" :end_date="search_endDate"  :searchName="searchName" :searchValue='search_value' @click_sub="handle_data_sub"></xw-date>
		<view class="total">
