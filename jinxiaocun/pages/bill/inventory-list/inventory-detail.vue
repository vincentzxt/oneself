		...
		<view class="main">
			<view class="list">
				<view class="list-cell">
					<view class="list-cell-left">订单编号</view><view class="list-cell-right">{{id}}</view>
				</view>
				<view class="list-cell">
					<view class="list-cell-left">下单时间</view><view class="list-cell-right">{{dataList.createtime}}</view>
				</view>
				<view class="list-cell">
					<view class="list-cell-left">盘点人</view><view class="list-cell-right">{{dataList.realname}}</view>
				</view>
				<view class="list-cell">
					<view class="list-cell-left">盘亏数量</view><view class="list-cell-right">{{dataList.totalQty1 || '0'}}</view>
				</view>
				<view class="list-cell">
					<view class="list-cell-left last-cell">盘盈数量</view><view class="list-cell-right">{{dataList.totalQty2 || '0'}}</view>
				</view>
				</view>
			<view class="box">
				<t-table border="1" border-color="#cccccc" :is-check="false">
					...
					<t-tr font-size="12" color="#5d6f61" align="right" v-for="(item, index) in dataList.detailModels" :key="index">
						...
						<t-td align="center">{{ item.chanegeqty }}</t-td>
					</t-tr>
				</t-table>
			</view>
		</view>
