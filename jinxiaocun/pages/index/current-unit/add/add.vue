			...
			<scroll-view :scroll-y="true" class="fill">
					...
					<view style="margin-top:5px">
						<cu-panel>
							...
							<cu-cell title="速查码">
								<input class="h50" style="height:50px;" slot="footer" type="text" v-model="reqData.querycode" placeholder-style="color:#c5c8ce" placeholder="用于开单快速搜索"/>
							</cu-cell>
							<cu-cell title="联系人名称">
								<input class="h50" style="height:50px;" slot="footer" type="text" v-model="reqData.bseContactUnitContactModels[0].contactname" placeholder-style="color:#c5c8ce" placeholder="请输入联系人名称"/>
							</cu-cell>
							...
							<cu-cell title="邮箱" isLastCell :disVerMessage="verify.email.disVerMessage" :verify="verify.email.message">
								<input class="h50" style="height:50px;" slot="footer" type="text" v-model="reqData.bseContactUnitContactModels[0].email" placeholder-style="color:#c5c8ce" placeholder="请输入邮箱" @blur="handleVerify('email')"/>
							</cu-cell>
						</cu-panel>
					</view>
